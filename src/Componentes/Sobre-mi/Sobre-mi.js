        ...
        <Container id='sobre-mi' className='bloque-sobre-mi'>
            <Row className='modo-escritorio'>
                <Col className='d-flex justify-content-center align-items-center'>
                    <img src={imagen} alt='teofilo' className='center-block imagen-teo'></img>
                </Col>
                <Col className='align-items-center'>
                    <h2  className='titulo-h2 text-center' >Sobre Mi</h2>
                    {Item.map((item) =>(
                        <div key={item.id}>
                        <p className="texto-cuerpo">{item.contenido01}</p>
                        <p className="texto-cuerpo">{item.contenido02}</p>
                        </div>
                    ))}
                </Col>
            </Row>
            <Row className='modo-mobil'>
                ...
                <Col className='d-flex justify-content-center align-items-center'>
                    <img src={imagen} alt='teofilo' className='center-block'></img>
                </Col>
            </Row>
        </Container>
    </>
